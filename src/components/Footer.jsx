        ...
        <footer id="contato" className="py-12 px-6 bg-slate-950 text-slate-400 border-t border-slate-800 text-center">
            <div className="max-w-4xl mx-auto flex-col items-center">
                ...
                <div className="flex flex-wrap justify-center gap-6 mb-12">
                    ...
                    <a href="#" className="flex items-center gap-2 px-6 py-3 rounded-full bg-slate-900 border border-slate-800 hover:bg-slate-800 hover:text-white transition-colors group">
